            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 medium-title">New Blog Post</h1>
                    </div>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-dark">Write New Article</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                Article
                                                <textarea class="form-control form-theme" name="article" rows="50" placeholder="Once upon a time..." required style="white-space: pre-wrap;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body" >
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="submit" name="blog" class="btn btn-primary btn-block" value="Post">
                                        </div>
                                    </div>
                                </div>
                            </div>
