            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample05">
                    <ul class="navbar-nav ml-auto custom-nav-text centeredContent">
                        <li class="nav-item">
                            <a href="/" class="nav-link">Explore Palettes</a>
                        </li>
                        <li class="nav-item">
                            <a href="/saved-palettes" class="nav-link" id="closeNav" data-toggle="collapse" data-target="#navbarsExample05" aria-controls="navbarsExample05" aria-expanded="false">Saved Palettes</a>
                        </li>
                        <li class="nav-item">
